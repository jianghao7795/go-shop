...
var Coupons = []Coupon{
	{Title: "新人专享券", Amount: 10, Condition: "满 99 元可用"},
	{Title: "全场通用券", Amount: 20, Condition: "满 199 元可用"},
	{Title: "数码品类券", Amount: 50, Condition: "满 499 元可用"},
	{Title: "满减优惠券", Amount: 100, Condition: "满 999 元可用"},
}
